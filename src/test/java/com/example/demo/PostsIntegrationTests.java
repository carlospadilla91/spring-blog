...
public class PostsIntegrationTests {
    ...
    public void contextLoads() {
        ...
        // This is checking to make sure the app is up and running
        assertNotNull(mvc);
    }
    ...
    public void testPostsIndex() throws Exception {
        ...
        this.mvc.perform(get("/posts"))
                ...
                .andExpect(content().string(containsString("All Posts"))) // this needs to match strings that in our index.html
                // Test the dynamic content of the page
